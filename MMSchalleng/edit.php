...
<div class="table-responsive">
  ...
  <div class="form-floating">
        ...
        <div class="form-floating">
          <input type="text" class="form-control" id="floatingInput" placeholder="movie_name" name="emri" value="<?php echo  $user_data['movie_name'] ?>">
          <label for="floatingInput">Movie Name</label>
        </div>
        <div class="form-floating">
          <input type="text" class="form-control" id="floatingInput" placeholder="movie_desc" name="username" value="<?php echo  $user_data['movie_desc'] ?>">
          <label for="floatingInput">Movie Desc</label>
        </div>
        <div class="form-floating">
          <input type="text" class="form-control" id="floatingInput" placeholder="movie_quality" name="email" value="<?php echo  $user_data['movie_quality'] ?>">
