...
$sql="SELECT movies,movie_name,users.email,bookings.id,bookings.nr_tickets,date,bookings.date,bookings.is_approved,bookings.time FROM movies
    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      ...
      <div class="table-responsive">
        <table class="table table-striped table-sm">
          ...
          <tbody>
            <?php
            foreach($bookings_data as $bookings_data) {
                ?>
                <tr>
