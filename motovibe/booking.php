<?php 
   ...
   if ($_SESSION['is_admin'] == 'true') {
     ...
     $sql = "SELECT moto.moto_name, users.email,bookings.id, bookings.nr_tickets, bookings.date, bookings.is_approved, bookings.time FROM moto
     INNER JOIN bookings ON moto.id = bookings.movie_id
    ...
    $bookings_data = $selectBookings->fetchAll();
      ...
      $sql = "SELECT moto.moto_name, users.email, bookings.nr_tickets, bookings.date,bookings.is_approved, bookings.time
            FROM moto INNER JOIN bookings ON moto.id = bookings.moto_id 
  ...
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      ...
      <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="list_moto.php">
